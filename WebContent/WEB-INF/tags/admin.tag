 11.1967 26.5176C14.9587 26.5176 16.657 25.2765 17.4502 24.2194C17.8627 23.6701 18.0678 23.1209 18.1691 22.712C18.2188 22.5156 18.2516 22.3153 18.267 22.1133L18.2681 22.092V21.5086C18.2681 21.2742 18.175 21.0494 18.0092 20.8836C17.8435 20.7178 17.6186 20.6247 17.3842 20.6247H5.00921C4.77478 20.6247 4.54994 20.7178 4.38418 20.8836C4.21841 21.0494 4.12528 21.2742 4.12528 21.5086V22.092ZM20.1539 25.4804C21.0649 25.7598 22.1892 25.9283 23.5693 25.9283C26.834 25.9283 28.6584 24.9901 29.6496 23.8587C30.0453 23.4106 30.3389 22.8818 30.51 22.3089C30.5768 22.0774 30.6199 21.8397 30.6384 21.5994L30.6408 21.544V21.5086C30.6408 20.8054 30.3614 20.1309 29.8641 19.6336C29.3668 19.1362 28.6923 18.8569 27.989 18.8569H20.1468C20.6111 19.3413 20.9506 19.9482 21.1109 20.6247H27.9902C28.2226 20.6247 28.4456 20.7162 28.6111 20.8794C28.7765 21.0427 28.871 21.2645 28.8741 21.4969L28.8682 21.5511C28.8564 21.64 28.8379 21.7278 28.8128 21.8139C28.7134 22.1397 28.5445 22.44 28.3178 22.6943C27.7627 23.3307 26.4946 24.1604 23.5693 24.1604C22.4603 24.1604 21.5893 24.0414 20.9046 23.8575C20.724 24.4281 20.4718 24.9734 20.1539 25.4804Z" fill="white" transform="scale(1.5)"/>
						</svg>
			            <a href="${sessao.urlPadrao}adm/usuarios">Usuários</a>
			        </li>
		        </c:if>
		        ...
		        <li class="nav-items-dashMenu">
		            <svg width="50" height="50" viewBox="0 0 23 23" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
					    <g id="Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					        <g id="Rounded" transform="translate(-136.000000, -4145.000000)">
					            <g id="Social" transform="translate(100.000000, 4044.000000)">
					                <g id="-Round-/-Social-/-school" transform="translate(34.000000, 98.000000)">
					                    <g>
					                        <polygon id="Path" points="0 0 24 0 24 24 0 24"></polygon>
					                        <path d="M5,13.18 L5,15.99 C5,16.72 5.4,17.4 6.04,17.75 L11.04,20.48 C11.64,20.81 12.36,20.81 12.96,20.48 L17.96,17.75 C18.6,17.4 19,16.72 19,15.99 L19,13.18 L12.96,16.48 C12.36,16.81 11.64,16.81 11.04,16.48 L5,13.18 Z M11.04,3.52 L2.61,8.12 C1.92,8.5 1.92,9.5 2.61,9.88 L11.04,14.48 C11.64,14.81 12.36,14.81 12.96,14.48 L21,10.09 L21,16 C21,16.55 21.45,17 22,17 C22.55,17 23,16.55 23,16 L23,9.59 C23,9.22 22.8,8.89 22.48,8.71 L12.96,3.52 C12.36,3.2 11.64,3.2 11.04,3.52 Z" id="🔹-Icon-Color" fill="none" stroke="#FFFFFF"></path>
					                    </g>
					                </g>
					            </g>
					        </g>
		            ...
		            <a href="${sessao.urlPadrao}adm/area-de-membros">Área de Membros</a>
		        </li>
	        ...
	        <div class="menu-perfil-dashboard">
		        <ul class="nav">
		         	<li class="nav-items-dashMenu ">	       
                        <c:if test="${not empty sessao.getConta() and not empty sessao.getConta().getImagem()}">    
				        	<svg class="perfil" width="48" height="48" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
				        		 <defs>
						            <clipPath id="circleClip">
						                <circle cx="29" cy="29" r="29" fill="#DDB6EA"/>
						            </clipPath>
						        </defs>
						        <circle cx="29" cy="29" r="29" fill="#414141"/>
				                <image href="${sessao.urlPadrao}arquivos/contas/perfil_${sessao.getConta().getId()}/${sessao.getConta().getImagem()}" 
				                x="0" y="0" width="58" height="58" clip-path="url(#circleClip)" />
					        </svg>
				        </c:if>
				        
				        <c:if test="${empty sessao.getConta() or empty sessao.getConta().getImagem()}">
				        	<svg class="perfil" width="48" height="48" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
				                <circle cx="29" cy="29" r="29" fill="#DDB6EA"/>		                
