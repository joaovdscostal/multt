...
<div class="card-body card-padding">
		<div class="form-row form-multt-padrao">
	        ...
	        <fieldset class="form-row col-md-12 fonte-padrao">
	        	<c:forEach items="${tipoTipoDeProdutoList}" var="tipo" varStatus="sts">
		            <div class="col-md-4">    
		                <input type="radio" name="produto.tipo" value="${tipo}" id="selectionOpt${sts.count}" class="selection-card" name="contact"/>            
		...
		<div id="form-container-produto" style="display:none">
			<div class="form-row form-multt-padrao">
