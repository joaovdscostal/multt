...
<template:admin>
		...
		<div class="container-fluid">
			<div class="header-body">
				<div class="row align-items-end">
					...
					<div class="col-auto">
						<a href="${sessao.urlPadrao}adm/condicoes-de-pagamento/novo" class="btn btn-primary">
							<i class="fas fa-plus"></i> Novo condição de pagamento
						</a>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<form class="form-inline" id="condicaodepagamentoForm">
					<div class="col p-0">
						<label class="sr-only" for="condicaodepagamentoNome">Nome</label>
			...
			<div class="col-12">
				<div class="table-responsive">
					<table class="table table-nowrap" id="condicaodepagamentoDatatable">
					</table>
				</div>
			</div>
		</div>
