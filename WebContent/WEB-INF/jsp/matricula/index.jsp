...
<template:admin>
		...
		<div class="container-fluid">
			<div class="header-body">
				<div class="row align-items-end">
					...
					<div class="col-auto">
						<a href="${sessao.urlPadrao}adm/matriculas/novo" class="btn btn-primary">
							<i class="fas fa-plus"></i> Nova matricula
						</a>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<form class="form-inline" id="matriculaForm">
					<div class="col p-0">
			...
			<div class="col-12">
				<div class="table-responsive">
					<table class="table table-nowrap" id="matriculaDatatable">
					</table>
				</div>
			</div>
		</div>
