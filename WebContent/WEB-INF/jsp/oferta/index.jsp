...
<template:admin>
		...
		<div class="container-fluid">
			<div class="header-body">
				<div class="row align-items-end">
					...
					<div class="col-auto">
						<a href="${sessao.urlPadrao}adm/ofertas/novo" class="btn btn-primary">
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<form class="form-inline" id="ofertaForm">
					<div class="col p-0">
						<label class="sr-only" for="ofertaNome">Nome</label>
			...
			<div class="col-12">
				<div class="table-responsive">
					<table class="table table-nowrap" id="ofertaDatatable">
					</table>
				</div>
			</div>
		</div>
